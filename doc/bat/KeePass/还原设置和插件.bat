...
xcopy /e/y/i/f "!backup%pos%!\%app_name%" "%appdata%\%app_name%" >nul || call :failed
xcopy /e/y/i/f "!backup%pos%!\Plugins" "%installLocation%\Plugins" >nul 2>&1
xcopy /e/y/i/f "!backup%pos%!\Languages" "%installLocation%\Languages" >nul 2>&1
echo ------------------------------------------
