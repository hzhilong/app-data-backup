...
if not exist "!backup%pos%!\MusicBee3Settings.ini" (
    echo 缺少配置文件 MusicBee3Settings.ini
    call :failed
)
md "%appdata%\%app_name%" >nul 2>&1
copy /y "!backup%pos%!\MusicBee3Settings.ini" "%appdata%\%app_name%\" >nul || call :failed
