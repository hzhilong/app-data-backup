...
md "%dir%"
if not exist "%appdata%\NeatDM" (
    echo 缺少配置文件
    call :failed
)

reg export "HKEY_CURRENT_USER\SOFTWARE\NeatDM" "%dir%\backup.reg" >nul 2>&1
xcopy /e/y/i/f "%appdata%\NeatDM" "%dir%\%app_name%" >nul || call :failed
