...
cd /d "%~dp0"
:: =================================================================================================
set app_name=Neat Download Manager
set installLocation=
...
md "%appdata%\NeatDM" >nul 2>&1
xcopy /e/y/i/f "!backup%pos%!\%app_name%" "%appdata%\NeatDM" >nul || call :failed
reg import "!backup%pos%!\backup.reg" >nul 2>&1
echo ------------------------------------------
