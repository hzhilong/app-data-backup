...
xcopy /e/y/i/f/exclude:exclusion.txt "%appdata%\obs-studio\" "%dir%\%app_name%" >nul || call :failed
xcopy /e/y/i/f "!installLocation!\obs-plugins\" "%dir%\obs-plugins" >nul || call :failed
xcopy /e/y/i/f "!installLocation!\data\obs-plugins\" "%dir%\data\obs-plugins" >nul || call :failed
