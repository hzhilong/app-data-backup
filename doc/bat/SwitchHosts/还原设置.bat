...
if not exist "!backup%pos%!\.SwitchHosts" (
    echo 缺少配置文件 .SwitchHosts
    call :failed
)

xcopy /e/y/i/f "!backup%pos%!\.SwitchHosts" "%userprofile%\.SwitchHosts" >nul || call :failed
echo ------------------------------------------
