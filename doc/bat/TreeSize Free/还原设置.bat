...
md "%appdata%\JAM Software" >nul 2>&1
md "%appdata%\JAM Software\%app_name%" >nul 2>&1
xcopy /e/y/i/f "!backup%pos%!\%app_name%" "%appdata%\JAM Software\%app_name%" >nul || call :failed
echo ------------------------------------------
